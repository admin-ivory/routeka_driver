                ...
                children: [
                  ...
                  Column(
                    ...
                    widget.dummystatus == true ?  const SizedBox(): ElevatedButton(
                      ...
                      const SizedBox(height: 10,),
                      widget.dummystatus == true ?  const SizedBox():   ElevatedButton(
                        style:  ButtonStyle(padding: const MaterialStatePropertyAll(EdgeInsets.zero),backgroundColor: MaterialStatePropertyAll<Color?>(notifier.theamcolorelight),shape: const MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(10))))),
                        onPressed: (){
