...
class _MyAccount_ScreenState extends State<MyAccount_Screen> {
  ...
  /*Future<void> pagelistapi() async {
    try {
      var response1 = await http.get(Uri.parse('https://kpanel.routeka.com/api/pagelist.php'));
      ...
      if (response1.statusCode == 200) {
        ...
        print('Failed to load page list. Status code: ${response1.statusCode}');
      }
    } catch (e) {
